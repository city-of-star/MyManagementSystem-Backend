...
public class PostController {
    ...
    @RequiresPermission(PermissionConstants.SYSTEM_POST_VIEW)
    @PostMapping("/page")
    ...
    @RequiresPermission(PermissionConstants.SYSTEM_POST_CREATE)
    @PostMapping("/create")
    ...
    @RequiresPermission(PermissionConstants.SYSTEM_POST_UPDATE)
    @PutMapping("/update")
    ...
    @RequiresPermission(PermissionConstants.SYSTEM_POST_DELETE)
