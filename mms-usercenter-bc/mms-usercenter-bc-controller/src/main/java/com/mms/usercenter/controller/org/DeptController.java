...
public class DeptController {
    ...
    @RequiresPermission(PermissionConstants.SYSTEM_DEPT_VIEW)
    @PostMapping("/page")
    ...
    @RequiresPermission(PermissionConstants.SYSTEM_DEPT_CREATE)
    @PostMapping("/create")
    ...
    @RequiresPermission(PermissionConstants.SYSTEM_DEPT_UPDATE)
    @PutMapping("/update")
    ...
    @RequiresPermission(PermissionConstants.SYSTEM_DEPT_DELETE)
