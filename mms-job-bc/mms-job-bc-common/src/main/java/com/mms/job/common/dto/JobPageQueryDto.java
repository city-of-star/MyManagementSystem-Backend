...
public class JobPageQueryDto {
    ...
    @Schema(description = "所属服务", example = "base")
    private String serviceName;

    @Schema(description = "任务编码（模糊查询）", example = "ATTACHMENT_CLEAN")
    private String jobCode;

    @Schema(description = "任务名称（模糊查询）", example = "附件清理任务")
    private String jobName;

    @Schema(description = "任务类型", example = "附件清理任务")
